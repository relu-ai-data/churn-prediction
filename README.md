...
**🔗 Live Demo**: [lucent-mochi-2c0ab1.netlify.app](https://lucent-mochi-2c0ab1.netlify.app)
...
このJSONがそのままフロントのモックとして機能し、仕様ブレがゼロになった。
...
#### 学び
品質基準を数値で定義しておくことで、「失敗しても代替案がある」設計が初めて成立する。
...
| レイヤー | サービス | URL |
|------|------|------|
| Frontend | Netlify | https://lucent-mochi-2c0ab1.netlify.app |
| Backend API | Render (Free) | https://churn-prediction-rgi9.onrender.com |

> **Note**: RenderのFreeプランはアイドル15分でスリープします。
> 初回アクセス時は50秒程度の待機が発生します。
> デモ前に `/health` エンドポイントへアクセスしてウォームアップ推奨。
